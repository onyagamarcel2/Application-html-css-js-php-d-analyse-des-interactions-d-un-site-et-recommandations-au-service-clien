...
<head>
    <title>Message</title>
    <!-- Incluez les fichiers CSS de Bootstrap -->
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
    <style>
        /* Définissez une taille par défaut pour la zone de texte */
        #message {
            height: 200px;
        }
...
<body>
    <div class="container">
        ...
        <a href="rdv.php" class="btn btn-primary">Retourner à la page RDV</a>
